...
plague_res = set()                                               #THIS IS THE TRUE FUCKING PHANTOM PAIN
                                                        #SO BASICALLY WHAT I HAVE DONE IS
                                                        #I HAVE USED A METRIC CALLED COSINE SIMILARITY
                                                        #IF YOU DON'T KNOW WHAT COSINE SIMILARITY MEANS, 
                                                        #THEN YOU ARE PROBABLY JUST AS DUMB AS I WAS 4 HOURS AGO
                                                        ...
                                                        #NOW IF THIS CHECKER SOUNDS TOO PRIMITIVE, THEN
                                                        #WELL IM SORRY, BUT I HAD ONLY 2 DAYS TO COME UP WITH THIS
                                                        ...
                                                        #THE REST OF THE RULES ARE UPTO YOU
